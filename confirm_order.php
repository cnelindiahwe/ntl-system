...
if (isset($_POST['appointment'])) {
	$date = date("Y-m-d");
	$sql = "INSERT INTO job_appointment (customer_id, quotation_id, date) VALUES ('".$customer_id."', '".$quotation_id."', '".$date."');";
	$res = mysqli_query($conn, $sql);
...
?>
				<tr style="text-align: left;">
					...
					<td>
						Width: <?php echo $row['width'];?><br>Height: <?php echo $row['height'];
...
if ($state == "Confirmed") {
$d = 0;
$sql = "SELECT * FROM job_appointment WHERE quotation_id = '".$quotation_id."';";
$res = mysqli_query($conn, $sql);
...
if ($d == 0) {?>
    ...
    <div class="container">
    	<form id="form1" name="form1" method="post">
            <p align="center">
              <label>
              <input name="appointment" type="submit" class="btn btn-success" onclick="return confirm('Please make sure this order is OK.')" value="Set Job Appointment">
              </label>
