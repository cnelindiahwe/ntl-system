...
if ($_SESSION['center_id'] == "5") {?>
    	<a href="account88.php" class="btn btn-success" style="min-width: 200px;">帳目卡</a>
<?php } else {
  ...
  if ($myrow['status'] == 1) {?>
    	<a href="register_new_customer.php" class="btn btn-success" style="min-width: 200px;">註冊新客戶</a>
    	<a href="customer_card.php" class="btn btn-success" style="min-width: 200px;">客戶卡</a>
<?php  }
  ...
  if ($myrow['status'] == 1) {?>
    	<a href="register_new_customer.php" class="btn btn-success" style="min-width: 200px;">註冊新客戶</a>
    	<a href="customer.php" class="btn btn-success" style="min-width: 200px;">客戶卡</a>
  <?php }
  ...
  if ($myrow['status'] == 1) {
    if ($_SESSION['group_name'] == "admin") {?>
    	<a href="order_list.php" class="btn btn-success" style="min-width: 200px;">待處理訂單</a>
    	<a href="complete_order_list.php" class="btn btn-success" style="min-width: 200px;">已完成訂單</a>
  ...
  $myrow = mysqli_fetch_assoc($res);
  if ($myrow['status'] == 1) {?>
    	<a href="collection.php" class="btn btn-success" style="min-width: 200px;">收集</a>
<?php  }
}?>
...
<?php
  ...
  $myrow = mysqli_fetch_assoc($res);
  if ($myrow['status'] == 1) {?>
    	<a href="monthly_report.php" class="btn btn-success" style="min-width: 200px;">月度報告</a>
<?php  }?>
...
<?php
  ...
  $myrow = mysqli_fetch_assoc($res);
  if ($myrow['status'] == 1) {?>
    	<a href="daily_report.php" class="btn btn-success" style="min-width: 200px;">每日報告</a>
<?php  }?>
...
<?php
  ...
  $myrow = mysqli_fetch_assoc($res);
  if ($myrow['status'] == 1) {?>
    	<a href="uncollected_report.php" class="btn btn-success" style="min-width: 200px;">未收集的報告</a>
<?php  }?>
...
<?php
  ...
  $myrow = mysqli_fetch_assoc($res);
  if ($myrow['status'] == 1) {?>
    	<a href="customer_status_check.php" class="btn btn-success" style="min-width: 200px;">客戶狀態查詢</a>
<?php  }?>
<?php 
    
    if($_SESSION["group_name"] =='superadmin'){     
      ?>
    	<a href="hwe_center_maintainace.php" class="btn btn-success" style="min-width: 200px;">中心管理</a>
    	<a href="user_maintenance.php" class="btn btn-success" style="min-width: 200px;">用戶管理</a>
                  <?php 
      }
       ?>
                  <?php 
    ...
    if($_SESSION["group_name"] =='admin'){
      ...
      $myrow = mysqli_fetch_assoc($res);
      if ($myrow['status'] == 1) {?>
    	<a href="product_list.php" class="btn btn-success" style="min-width: 200px;">產品管理</a>
       <?php }
      }
       ?>
    </section>
