...
<section>
	<div class="">
		...
		的月度報告<span class="ConfirmValue">  </span></p>
	</div>
	...
	elseif ($_SESSION['group_name'] != "admin") {
		...
		if(isset($all_center) && !empty($all_center))
		{
			...
			if($results->num_rows > 0)
			{
				...
				<caption class="menu-header">月度收集報告</caption>
...
?>
      ...
      <tr>
        <td class="ConfirmValue" colspan="15">報告生產於<font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> <?php echo date("d/m/Y H:i:s");?></strong></font></td>
      </tr>
    		</tbody>
				<?php }?>
				</table>
		...
		{								
            ...
            <?php }?>
			<table cellspacing="1" cellpadding="1" style="width:80%" class="table table-striped table-bordered" align="center">
			<caption class="menu-header">月度收集报告</caption>
			<?php if ($_SESSION['center_id']!= 5) {?>
				<thead>
					<tr>
						<th>顾客 - 卡</th>
...
<section>
    ...
    <p><span class="ConfirmValue"> <strong><?php 
		...
		{
			echo $t_center_id;
		}?> : <?php echo $d_startYear.$d_startMonth;?></strong>的月度餘額報告</span></p>
		<a href="monthly_report.php" class="btn btn-info">返回</a>
		<br>
    </div>
        <table cellspacing="1" cellpadding="1" style="width:100%" class="table table-striped table-bordered">
        <caption class="menu-header">月度餘額報告</caption>
        <thead>
            <tr>
                <th>日期</th>
                <th>貸款</th>
      ...
      <tr>
        <td class="ConfirmValue">報告生產於<font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> <?php echo date("d/m/Y H:i:s");?></strong></font></td>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
...
?>
			...
			if ($_SESSION['center_id'] != 5) {?>
      <tr>
        <td colspan="6" class="ConfirmValue">報告生產於<font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> <?php echo date("d/m/Y H:i:s");?></strong></font></td>
        ...
        <td></td>
			...
			<?php } else {?>
      <tr>
        <td colspan="7" class="ConfirmValue">報告生產於<font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> <?php echo date("d/m/Y H:i:s");?></strong></font></td>
...
<?php } else {?>
    ...
    <form id="form1" name="form1" method="post" action="monthly_report.php">
		...
		<!-- checkbox hide user  -->
			<?php
				...
				<div class="row form-group">
					...
					<div class="col-md-2"></div>
					<div class="col-md-6">
						<input type="checkbox" name="all_center" value="all"/>  所有中心
					</div>
					<div class="col-md-2"></div>
				</div>
					<?php
		...
		<div class="row form-group">
			...
			<div class="col-md-2"></div>
			<div class="col-md-6">
				<input name="rpt01" type="submit" class="btn btn-success" id="rpt01" value="月度收集報告">
			</div>
			<div class="col-md-2"></div>
		</div>
		<?php if ($_SESSION['center_id'] != 5) {?>
		<div class="row form-group">
			...
			<div class="col-md-2"></div>
			<div class="col-md-6">
				<input name="rpt02" type="submit" class="btn btn-success" id="rpt02" value="月度餘額報告">
			</div>
			<div class="col-md-2"></div>
		</div>
	<?php } else {?>
		<div class="row form-group">
			...
			<div class="col-md-2"></div>
			<div class="col-md-6">
				<input name="rpt06" type="submit" class="btn btn-success" id="rpt06" value="月度貸款報告">
			</div>
			<div class="col-md-2"></div>
		</div>
		<div class="row form-group">
			...
			<div class="col-md-2"></div>
			<div class="col-md-6">
				<input name="rpt03" type="submit" class="btn btn-success" id="rpt03" value="月度結單報告">
			</div>
			<div class="col-md-2"></div>
		</div>
		<div class="row form-group">
			...
			<div class="col-md-2"></div>
			<div class="col-md-6">
				<input name="rpt04" type="submit" class="btn btn-success" id="rpt04" value="月度截止報告">
			</div>
			<div class="col-md-2"></div>
		</div>
		<div class="row form-group">
			...
			<div class="col-md-2"></div>
			<div class="col-md-6">
				<input name="rpt05" type="submit" class="btn btn-success" id="rpt05" value="月度總結報告">
			</div>
			<div class="col-md-2"></div>
		</div>
	<?php }?>
