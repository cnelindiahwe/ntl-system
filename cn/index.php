...
if($domain_status==1){
  ...
  if(empty($companyid))
  {
    ...
    if(mysqli_num_rows($get_admin_data) > 0)
    {
      ...
      <script>
      window.location.replace("<?php echo SITEURL?>/cn/dashboard.php");
      </script>
    <?php
    }
    else
...
<div class="form-group">
  <input type="text" class="form-control" placeholder="公司編號" name="companyid" style="border-radius: 10rem;padding:1.0rem 1rem;width:260px;"><br>
  <input type="text" class="form-control" placeholder="登錄ID" name="user_id" style="border-radius: 10rem;padding:1.0rem 1rem;width:260px;"><br>
 <input type="password" class="form-control" placeholder="密碼" name="Password" style="border-radius: 10rem;padding:1.0rem 1rem;width:260px;"><br>
<input type="submit" class="form-control" placeholder="登錄" name="submit" style="border-radius:10rem;width:260px;background-color:#4e73df;text-align:center;color: #fff !important;" value="登錄"><br>
<input type="reset" class="form-control" placeholder="重置" name="reset" style="border-radius:10rem;width:260px;background-color:#4e73df;text-align:center;color: #fff !important;" value="重置"> 
