...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="">
          <center><h1><?php echo $myrow['code'];?> - 還款</h1></center>
        	...
        	<form id="form1" name="form1" method="post" enctype="multipart/form-data">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                    	...
                    	<input name="NewCard" class="btn btn-success" type="submit" id="NewCard" value="還款">&nbsp;&nbsp; <input type="reset" class="btn btn-success" name="Submit2" value="重置">
