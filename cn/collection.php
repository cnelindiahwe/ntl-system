    ...
    <tbody><tr>
      <td>
	    <table cellspacing="0" cellpadding="0" border="0">
          <tbody><tr>
            <td colspan="3"><div align="left">中心 ID :<span class="SpecialHeader"><?php echo $t_center_id;?>
        ...
        <thead>
        	<tr>
                ...
                <th><div align="center">截止</div></th>
                <th><div align="center">清算付款</div></th>
                <th><div align="center">數額</div></th>
                <th><div align="center">利息</div></th>
<?php
if ($t_center_id != 5) {?>
                <th><div align="center">姓名</div></th>
                <th><div align="center">電話</div></th>
                <th><div align="center">Z</div></th>
                <th><div align="center">開始</div></th>
                <th><div align="center">nT</div></th>
                <th><div align="center">結束</div></th>
...
<?php } else {?>
                ...
                <th><div align="center">結束</div></th>
<?php }?>
                <th><div align="center">為期</div></th>
<?php
if ($t_center_id != 5) {?>
                <th><div align="center">客戶 ID</div></th>
<?php }?>
                <th><div align="center">卡 ID</div></th>
          </tr>
...
<?php }?>
        ...
        <tr>
        	<td colspan="15" class="ErrMsg"><div align="center">***** 此中心目前沒有紀錄 ***** </div></td>
        </tr>
        <?php }?>
    </tbody></table>
    </td>
...
<?php }else{?>
	<tr>
	<td style="width:10%">費用</td>
    <td style="width:20%">數額</td>
	</tr>
	<tr>
		<td>Misc.</td>
        ...
        <form id="form1" name="form1" method="get" action="collection.php">
            ...
            <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-2"></div>
                    <div class="col-md-6">
                    	<input name="Search" type="submit" class="btn btn-success" id="Search" value="搜索">
