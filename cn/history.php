      ...
      <td colspan="2"><table width="100%" cellspacing="1" cellpadding="1">
        <thead>
            <tr>
                ...
                <td>描述</td>
                <td>備注</td>
                <td style="text-align: right;">收集</td>
        ...
        <tbody>
			...
			?>
            <tr>
                <td>(<a style="color: blue; text-decoration: underline;" href="edit_record.php?c=<?php echo $row['id'];?>">修改紀錄</a><?php if ($row['image'] != null) {?>/<a style="color: blue; text-decoration: underline;" href="receipt.php?c=<?php echo $row['id'];?>" target="_blank">查看收據</a><?php }?>/<a style="color: blue; text-decoration: underline;" href="delete_record.php?c=<?php echo $row['id'];?>" onclick="return confirm('Are you sure?')">刪除紀錄</a>)</td>
