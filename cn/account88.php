...
<div class="content-wrapper">
   ...
   <br/>
	...
	<form method="post">
		...
		<br>
		<label>借出日期/截止日期/結單日期/code/经手人：</label>
        	...
        	<table cellspacing="0" cellpadding="2" align="center" class="table table-bordered table-striped">
	            ...
	            <tbody>
				  ...
				  ?>
				  	...
				  	<tr>
				  		<td>
				  			<a href="edit_history.php?c=<?php echo $row['id'];?>" class="btn btn-success">編輯</a>
...
if ($row['clear_payment'] == 1) {
	...
	echo date("d-m-Y",$myrow2['d_date_disp']);
				  		...
				  		<?php if ($row['clear_payment'] != 1) {?>
				  			<a href="collection88.php?c=<?php echo $row['id'];?>" class="btn btn-success">還款</a>
				  		<?php }?>
				  		</td>
                   </tr>
                   <?php }}?>
