...
if ($_SESSION['center_id'] == "5") {?>
                <li><a href="account88.php"><i class="fa fa-plus"></i>帳目卡</a></li>
<?php } else {
  ...
  $myrow = mysqli_fetch_assoc($res);
  if ($myrow['status'] == 1) {?>
                <li><a href="register_new_customer.php"><i class="fa fa-plus"></i>註冊新客戶 </a></li>
                <li><a href="customer_card.php"><i class="fa fa-plus"></i>客戶卡</a></li>
<?php  }
  ...
  if ($myrow['status'] == 1) {?>
                <li><a href="register_new_customer.php"><i class="fa fa-plus"></i>註冊新客戶 </a></li>
                <li><a href="customer.php"><i class="fa fa-plus"></i>客戶卡</a></li>
  <?php }
  ...
  if ($myrow['status'] == 1) {
    if ($_SESSION['group_name'] == "admin") {?>
                <li><a href="order_list.php"><i class="fa fa-plus"></i>待處理訂單</a></li>
                <li><a href="complete_order_list.php"><i class="fa fa-plus"></i>已完成訂單</a></li>
  ...
  $myrow = mysqli_fetch_assoc($res);
  if ($myrow['status'] == 1) {?>
                <li><a href="collection.php"><i class="fa fa-plus"></i>收集</a></li>
<?php  }
}?>
...
<?php
  ...
  $myrow = mysqli_fetch_assoc($res);
  if ($myrow['status'] == 1) {?>
                <li><a href="monthly_report.php"><i class="fa fa-plus"></i>月度報告</a></li>
<?php  }?>
...
<?php
  ...
  $myrow = mysqli_fetch_assoc($res);
  if ($myrow['status'] == 1) {?>
                <li><a href="daily_report.php"><i class="fa fa-plus"></i>每日報告</a></li>
<?php  }?>
...
<?php
  ...
  $myrow = mysqli_fetch_assoc($res);
  if ($myrow['status'] == 1) {?>
                <li><a href="uncollected_report.php"><i class="fa fa-plus"></i>未收集的報告</a></li>
<?php  }?>
...
<?php
  ...
  $myrow = mysqli_fetch_assoc($res);
  if ($myrow['status'] == 1) {?>
                <li><a href="customer_status_check.php"><i class="fa fa-plus"></i>客戶狀態查詢</a></li>
<?php  }?>
<?php 
    
    if($_SESSION["group_name"] =='superadmin'){     
      ?>
                <li id="hwe_center_maintainace"><a href="center_maintenance.php"><i class="fa fa-plus"></i>中心管理</a></li>
                <li id="id_user_maintainance"><a href="user_maintenance.php"><i class="fa fa-plus"></i>用戶管理</a></li>
                  <?php 
      }
       ?>
                  <?php 
    ...
    if($_SESSION["group_name"] =='admin'){
      ...
      $myrow = mysqli_fetch_assoc($res);
      if ($myrow['status'] == 1) {?>
                <li id="id_user_maintainance"><a href="product_list.php"><i class="fa fa-plus"></i>產品管理</a></li>
       <?php }
      }
       ?>
                <li><a href="change_password.php?id=<?php echo $_SESSION["agent_id"];?>"><i class="fa fa-plus"></i>更改密碼</a></li>
          ...
          <div class="nav_menu">
			...
			?>
                  ...
                  <a class="dropdown-item"  href="javascript:;">Help</a>-->
                    <a class="dropdown-item"  href="logout.php"><i class="fa fa-sign-out pull-right"></i>登出</a>
                  </div>
                </li>
