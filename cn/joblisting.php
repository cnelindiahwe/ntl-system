...
<div class="content-wrapper">
    ...
    <section class="content-header">
	 ...
	 <div>
		<button onclick="window.print()" class="btn btn-success">打印</button>
		</div>
<section>
    ...
    <tbody><tr>
      <td>
	    <table cellspacing="0" cellpadding="0" border="0">
          <tbody><tr>
           <!-- <td><div align="left">Center ID :<span class="SpecialHeader"> <?php //echo $t_center_id;?>
			...
			<td><div align="left">中心 ID :<span class="SpecialHeader"> <?php 
			//echo $t_center_id;
			//die;
          ...
          <tr>
            <td><div align="left">日期 : <span class="SpecialHeader"><?php echo $d_startDay.'-'.$d_startMonth.'-'.$d_startYear; ?></span>
        ...
        <tbody><tr>
          ...
          <td><div align="center">數額</div></td>
          <td><div align="center">利息</div></td>
          <td><div align="center">姓名</div></td>
          <td><div align="center">電話</div></td>
          <td><div align="center">Z</div></td>
          <td><div align="center">開始</div></td>
          <td><div align="center">nT</div></td>
          <td><div align="center">截止</div></td>
          <td><div align="center">截止天數</div></td>
          <td><div align="center">為期</div></td>
          <td><div align="center">顧客卡 ID </div></td>
          </tr>
