...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (mysqli_query($conn, $sql)) {
        if ($remark1 == "清") {
            $sql = "UPDATE customers_card SET clear_payment = '1' WHERE id = '".$myrow['card_id']."';";
...
<div class="content-wrapper">
	...
	<a href="account88.php" class="btn btn-info">返回</a>
	<section>
    	<div class="container">
        	<form id="form1" name="form1" method="post">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                    	...
                    	<input name="NewCard" class="btn btn-success" type="submit" id="NewCard" value="保存修改">&nbsp;&nbsp; <input type="reset" class="btn btn-success" name="Submit2" value="重置">
