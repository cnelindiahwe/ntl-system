...
<section>
	<div class="">
		<p><strong>		
		<?php echo $d_startDay.'-'.$d_startMonth.'-'.$d_startYear;?></strong>的每日報告<span class="ConfirmValue">  </span></p>
	</div>
...
if ($_SESSION['center_id'] == 5) {?>
	<form method="post">
		...
		<label>借貸日期/截止日期：</label>
		<input type="date" name="searchDate">
		<br>
		<label>Code/經手人：</label>
	...
	elseif ($_SESSION['group_name'] != "admin") {
		...
		if(isset($all_center) && !empty($all_center))
		{
			...
			if($results->num_rows > 0)
			{
				...
				?>
				<div>
					<p>中心<span class="ConfirmValue"> <strong>
				...
				<caption class="menu-header">每日收集報告</caption>
...
<section>
    <form id="form1" name="form1" method="post" action="collection.php">
      <table align="center">
        <tr>
          <td><strong><?php echo $date ?>的每日餘額</strong><br>
            <table width="150%" cellspacing="1" cellpadding="1" border="1">
			
              <tbody><tr>
                <td colspan="5"><strong>之前的餘額</strong></td>
              ...
              <tr>
                <td colspan="5"><strong>總收集</strong></td>
                <td><div align="right"><?php echo $total_collection; ?></div></td>
              </tr>
			  <tr>
                <td colspan="5"><strong>總理系</strong></td>
              ...
              <tr>
                <td colspan="6"><strong>開銷</strong></td>
              </tr>
               <tr>
                <td colspan="5"><strong>&nbsp;高級</strong></td>
               ...
               <tr>
                ...
                <tr>
                 <tr>
                <td colspan="5"><strong>&nbsp;雜費</strong></td>
                <td><div align="right"><?php echo $misc; ?></div></td>
              </tr>
               <tr>
                <td colspan="5"><strong>&nbsp;維修</strong></td>
...
<section>
	<div class="">
		<p><strong>		
		<?php echo $d_startDay.'-'.$d_startMonth.'-'.$d_startYear;?></strong>的每日結單<span class="ConfirmValue"></span></p>
	</div>
	<a href="daily_report.php" class="btn btn-info">返回</a>
<?php
if ($_SESSION['center_id'] == 5) {?>
...
<?php }?>
	...
	<table cellspacing="1" cellpadding="1" style="width:100%" class="table table-striped table-bordered">
        <caption class="menu-header">每日結單報告</caption>
        <thead>
            <tr>
                <th>開始日期</th>
                <th>Code</th>
...
<section>
	<div class="">
		<p><strong>		
		<?php echo $d_startDay.'-'.$d_startMonth.'-'.$d_startYear;?></strong>的每日截止<span class="ConfirmValue"></span></p>
	</div>
	<a href="daily_report.php" class="btn btn-info">返回</a>
<?php
if ($_SESSION['center_id'] == 5) {?>
...
<?php }
	...
	<table cellspacing="1" cellpadding="1" style="width:100%" class="table table-striped table-bordered">
        <caption class="menu-header">每日截止報告</caption>
        <thead>
            <tr>
            	<th>開始日期</th>
              <th>Code</th>
...
<section>
	<div class="">
		<p><strong>		
		<?php echo $d_startDay.'-'.$d_startMonth.'-'.$d_startYear;?></strong>的每日總結<span class="ConfirmValue"></span></p>
	</div>
	<a href="daily_report.php" class="btn btn-info">返回</a>
	<form method="post">
	...
	<table cellspacing="1" cellpadding="1" style="width:100%" class="table table-striped table-bordered">
        <caption class="menu-header">每日總結報告</caption>
        <thead>
            <tr>
            	<th></th>
            	<th>開始日期</th>
            	...
            	<th>總結單數額</th>
            	<th>總借貸數額</th>
            	<th><strong>總數</strong></th>
            	<th><strong>利潤</strong></th>
            	<th>經手人</th>
            	<th></th>
            </tr>
        </thead>
...
<section>
	<div class="">
		...
		的每日總結<span class="ConfirmValue"></span></p>
	</div>
	<a href="daily_report.php" class="btn btn-info">返回</a>
	<form method="post">
...
<?php } else {?>
    ...
    <form id="form1" name="form1" method="post" action="daily_report.php">
		...
		<div class="row form-group">
			...
			<div class="col-md-2"></div>
			<div class="col-md-6">
				<input name="rpt01" type="submit" class="btn btn-success" id="rpt01" value="每日收集報告">
			</div>
			<div class="col-md-2"></div>
		</div>
		<?php if ($_SESSION['center_id'] != 5) {?>
		<div class="row form-group">
			...
			<div class="col-md-2"></div>
			<div class="col-md-6">
				<input name="rpt02" type="submit" class="btn btn-success" id="rpt02" value="每日餘額報告">
			</div>
			<div class="col-md-2"></div>
		</div>
	<?php } else {?>
		<div class="row form-group">
			...
			<div class="col-md-2"></div>
			<div class="col-md-6">
				<input name="rpt06" type="submit" class="btn btn-success" id="rpt06" value="每日貸款報告">
			</div>
			<div class="col-md-2"></div>
		</div>
		<div class="row form-group">
			...
			<div class="col-md-2"></div>
			<div class="col-md-6">
				<input name="rpt03" type="submit" class="btn btn-success" id="rpt03" value="每日結單報告">
			</div>
			<div class="col-md-2"></div>
		</div>
		<div class="row form-group">
			...
			<div class="col-md-2"></div>
			<div class="col-md-6">
				<input name="rpt04" type="submit" class="btn btn-success" id="rpt04" value="每日截止報告">
			</div>
			<div class="col-md-2"></div>
		</div>
		<div class="row form-group">
			...
			<div class="col-md-2"></div>
			<div class="col-md-6">
				<input name="rpt05" type="submit" class="btn btn-success" id="rpt05" value="每日總結報告">
			</div>
			<div class="col-md-2"></div>
		</div>
	<?php }?>
