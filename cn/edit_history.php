...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if ($available == true) {
	    ...
	    echo "<script>alert('你的code已重複，請修改後再次嘗試。')</script>";
	}
}
?>
...
<?php 		break;
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                    	...
                    	<input name="NewCard" class="btn btn-success" type="submit" id="NewCard" value="更新">&nbsp;&nbsp; <input type="reset" class="btn btn-success" name="Submit2" value="重置">
