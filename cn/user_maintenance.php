            ...
            <form id="form1" name="form1" method="post" action="user_maintenance2.php">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                    	...
                    	<input name="Newuser" class="btn btn-success" type="submit" id="Newuser" value="<?php if(isset($_REQUEST['uid'])){?>更新<?php }else {?>創建<?php }?>">&nbsp;&nbsp; <input type="reset" class="btn btn-success" name="Submit2" value="重置">
    ...
    <section style="overflow-x: auto;">
        ...
        <thead>
            <tr>
                ...
                <th><strong>公司編號</strong></th>
                <th><strong>登錄ID</strong></th>
                <th><strong>用戶權限</strong></th>
                <th>&nbsp;</th>
            </tr>
        </thead>
        ...
        <tbody>
            ...
            <tr>
                <td>
                	<a href="user_maintenance.php?uid=<?php echo $row['id'];?>&amp;cmdEdit=Edit" class="btn btn-success">編輯</a>
                </td>
                ...
                <td>
                    ...
                    <a href="change_password.php?id=<?php echo $row['id'];?>" class="btn btn-success">更改密碼</a>
                </td>
            </tr>
            <?php }}?>
            ...
            <td colspan="7" class="ErrMsg">
                <div align="center">
                    <form id="form1" name="form1" method="post" action="user_maintenance.php">
                        <input name="cmdNew" type="submit" class="btn btn-success" id="cmdNew" value="新用戶">
                    </form>
                </div>
            </td>
        </tr>
