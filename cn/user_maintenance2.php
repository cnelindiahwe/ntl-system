...
if(isset($_POST['confirm_user']))
{
	...
	?>
	<script>
    	location.replace('<?php echo SITEURL."/cn/user_maintenance.php?success=".$success; ?>');
    </script>
	<?php
	}
}
        ...
        <div class="conatiner">
            <form id="form1" name="form1" method="post">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <input name="confirm_user" type="submit" class="btn btn-success" id="confirm_user" value="確認">
                    </div>
                    <div class="col-md-2"></div>
                </div>
            </form>
