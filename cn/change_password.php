   ...
   <br/>
    ...
    <section>
        ...
        <div class="row">
            ...
            <div class="col-md-4 heading_title">更改用戶密碼</div>
            <div class="col-md-4"></div>
        </div>
        <br/>
        <div class="row">
            ...
            <div class="col-md-2">
                <label for="customer_id">用戶 ID</label>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-2"></div>
            <div class="col-md-2">
                <label for="customer_id">姓名</label>
            </div>
            <div class="col-md-6">
        ...
        <div class="row form-group">
            <div class="col-md-2"></div>
            <div class="col-md-2">
                <label for="customer_id">當前密碼</label>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-2"></div>
            <div class="col-md-2">
                <label for="customer_id">新密碼</label>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-2"></div>
            <div class="col-md-2">
                <label for="customer_id">確認密碼</label>
            </div>
            <div class="col-md-6">
        ...
        <div class="row">
            ...
            <div class="col-md-2"></div>
            <div class="col-md-6">
                <input type="submit" id="change_password" name="change_password" value="更換密碼" class="btn btn-success"/>
            </div>
            <div class="col-md-2"></div>
        </div>
        <br/>
