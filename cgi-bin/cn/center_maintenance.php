...
$center_detail_table = "CREATE TABLE IF NOT EXISTS center_detail (
...
if(isset($_POST['cmdNewcenter']) || isset($_REQUEST['error']) || (isset($_REQUEST['cid']) && isset($_REQUEST['cmdEdit'])))
{
	...
	$select_sql = "SELECT * FROM center_detail WHERE id = $center_id ";
	...
	<div class="conatiner">
    	<form id="form1" name="form1" method="post" action="center_maintenance2.php">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-6">
                    <input name="cmdNewcreate" type="submit" class="btn btn-success" id="cmdNewcreate" value="<?php if(isset($center_id)){?>&#26356;&#26032;<?php }else{?>Create<?php }?>">
                    &nbsp;&nbsp;
<input type="reset" name="Submit2" class="btn btn-success" value="&#37325;&#21551;">
                </div>
                <div class="col-md-2"></div>
            </div>
    	</form>
...
else
{
    ...
    <form id="form1" name="form1" method="post" action="center_maintenance.php">
      <table cellspacing="0" cellpadding="2" border="1" align="center" class="table table-striped table-bordered" style="width: 100%;">
        ...
        <tbody>
        	<?php 
				$select_center_deatil = "SELECT * FROM center_detail";
			...
			?>
            <tr>
                <td><a href="center_maintenance.php?cid=<?php echo $row['id'];?>&amp;cmdEdit=Edit" class="btn btn-success">&#32534;&#36753;</a></td>
        ...
        <td colspan="6"><div align="center">
          <input name="cmdNewcenter" type="submit" class="btn btn-success" id="cmdNew" value="&#26032;&#20013;&#24515;">
        </div></td>
      </tr>
      </tbody></table>
      <p>&nbsp;</p>
