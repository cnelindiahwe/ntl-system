...
<div class="form-group">
  <h3><span class="style8">Select Language<br>
    ...
    <br>
    <input type="button" class="form-control" placeholder="login" name="submit" style="border-radius:10rem;width:260px;background-color:#4e73df;text-align:center;color: #fff !important;" value="English" onclick="window.location.href='http://crm2.ecomdemo.xyz/superadmin/login.php';">
    <br>
