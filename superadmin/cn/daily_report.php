	...
	if ($_SESSION["group_name"] == 'superadmin') {
		...
		if(isset($all_center) && !empty($all_center))
		{
			...
			if($results->num_rows > 0)
			{
				...
				<caption class="menu-header">每日收款报告</caption>
					<thead>
						<tr>
							<th>客户-卡</th>
                            <th>顾客姓名</th>
...
<section>
    <form id="form1" name="form1" method="post" action="collection.php">
      <table align="center">
        <tr>
          <td><strong>每日余额 <?php echo $date ?></strong><br>
            <table width="150%" cellspacing="1" cellpadding="1" border="1">
			
              <tbody><tr>
                <td colspan="5"><strong>以前的余额</strong></td>
              ...
              <tr>
                <td colspan="5"><strong>总收藏 </strong></td>
                <td><div align="right"><?php echo $total_collection; ?></div></td>
              </tr>
			  <tr>
                <td colspan="5"><strong>总利息 </strong></td>
                <td><div align="right"><?php echo $total_interest; ?></div></td>
              </tr>
                        <tr>
                <td colspan="5"><strong>Kongsi进</strong></td>
              ...
              <tr>
                <td colspan="6"><strong>花费</strong></td>
              </tr>
               <tr>
                <td colspan="5"><strong>&nbsp;预支</strong></td>
                <td><div align="right"><?php echo $advance; ?></div></td>
              </tr>
               <tr>
                <td colspan="5"><strong>&nbsp;Kongsi出</strong></td>
                <td><div align="right"><?php echo $outbalance; ?></div></td>
              </tr>
                <tr>
                 <tr>
                <td colspan="5"><strong>&nbsp;杂项</strong></td>
                <td><div align="right"><?php echo $misc; ?></div></td>
              </tr>
               <tr>
                <td colspan="5"><strong>&nbsp;修理</strong></td>
      ...
      <tr>
        <td colspan="5"><strong>借出</strong> </td>
  ...
  <tr>
    <td colspan="5"><strong>今日余额</strong></td>
