...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="">
          <center> <h1><?php if(isset($customer_id) && $customer_id!=''){?>编辑客户<?php }else{?>新客户<?php }?></h1></center>
    	...
    	<div class="container">
            <form method="post" id="myForm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <?php
							...
							{
						?>
                        <span style="color:red;">自动产生</span>
                        <?php }?>
                    </div>
                    <div class="col-md-2"></div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col-md-2"></div>
                    <div class="col-md-2">
                        <label for="customer_name">名称</label>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <div class="col-md-2"></div>
                    <div class="col-md-2">
                        <label for="customer_ic">新身份证</label>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <div class="col-md-2"></div>
                    <div class="col-md-2">
                        <label for="customer_Occupation">职业</label>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <div class="col-md-2"></div>
                    <div class="col-md-2">
                        <label for="customer_telephone">电话</label>
                    </div>
                    <div class="col-md-6">
                    	<div>
                ...
                <div class="row form-group">
                    <div class="col-md-2"></div>
                    <div class="col-md-2">
                        <label for="customer_fax">传真</label>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <div class="col-md-2"></div>
                    <div class="col-md-2">
                        <label for="customer_gender">性别</label>
                    </div>
                    <div class="col-md-6">                    
                   
                        <select name="t_gender" class="form-control" style="width:50%;"  required="required">
                            <option value="F" <?php if(isset($t_gender) && $t_gender=="F"){ echo 'selected="selected"';} ?>>F - 女性</option>
                            <option value="M" <?php if(isset($t_gender) && $t_gender=="M"){ echo 'selected="selected"';} ?>>M - 男性</option>
                        </select>
                    </div>
                    <div class="col-md-2"></div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col-md-2"></div>
                    <div class="col-md-2">
                        <label for="customer_guaranty_name">担保人姓名</label>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <div class="col-md-2"></div>
                    <div class="col-md-2">
                        <label for="customer_guaranty_ic_passpost">担保人身份证 /护照</label>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <div class="col-md-2"></div>
                    <div class="col-md-2">
                        <label for="customer_guaranty_telephone">担保人电话</label>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    <div class="col-md-2"></div>
                    <div class="col-md-2">
                        <label for="customer_guaranty_info">担保人信息</label>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                        <button type="submit" class="btn btn-success" name="create"><?php if(isset($customer_id) && $customer_id!=''){?>更新客户<?php }else{?>建立客户<?php }?></button>&nbsp;&nbsp;
                        <button type="reset" class="btn btn-success" name="reset">重启</button>
                    </div>
                    <div class="col-md-2"></div>
                </div>
        	</form>
