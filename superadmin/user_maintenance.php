            ...
            <form id="form1" name="form1" method="post" action="user_maintenance2.php">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
                    	...
                    	<?php
							$select_center_deatil = "SELECT * FROM center_detail ORDER BY show_sequence ASC";
    ...
    <section>
        ...
        <tbody>
				...
				$result = mysqli_query($conn,$select_user);
					if($result->num_rows > 0)
					{
						...
						while($row = $result->fetch_assoc()){
							...
							$select_center_name = "SELECT id, center_name FROM center_detail WHERE ID = ".$row['center_id'];
							$center='';
            ...
            <tr>
                ...
                <td><?php echo $center['id']." - ".$center['center_name'];?></td>
                ...
                <td>
                    ...
                    <a href="change_password.php?id=<?php echo $row['id'];?>" class="btn btn-success">Password</a>
                </td>
            </tr>
            <?php }}?>
