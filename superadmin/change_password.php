...
$error = $success ='';
  ...
  $sql = "SELECT * FROM super_admin_login";
  $result = mysqli_query($conn,$sql);

//	$sql = "SELECT * FROM super_admin_login WHERE id = ".$user_id;
	$result = mysqli_query($conn,$sql);
	//$row = '';
...
if(isset($_POST['change_password']))
{
	...
	if($row['password'] == '')
	{
		...
		{
			$sql12 = "  UPDATE super_admin_login SET password = '".$new_password."' WHERE id = ".$user_id;
   ...
   <br/>
    ...
    <section>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <span class="span_hwe"><?php echo $row['companyid'];?></span>
            </div>
            <div class="col-md-2"></div>
        </div>
        <br/>
        <div class="row">
            ...
            <div class="col-md-6">
                <span class="span_hwe"><?php echo $row['loginid'];?></span>
            </div>
            <div class="col-md-2"></div>
        </div>
        <br/>
