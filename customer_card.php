    ...
    <section>
    	<div class="container">
        	<table cellspacing="2" class="table customer_info" cellpadding="2" border="0" align="center" style="width: 70%;">
                    ...
                    <tbody><tr>
                      <td colspan="3" class="SubMenuCaption" bgcolor="#038603">Customer Information</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td bgcolor="#CCCCCC">IC/Passport : <span class="SpecialHeader"><?php echo $customer_ic;?></span> </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td bgcolor="#CCCCCC">Occupation : <span class="SpecialHeader"><?php echo $customer_Occupation;?></span></td>
                      <td bgcolor="#CCCCCC">Guarantor name : <span class="SpecialHeader"><?php echo $customer_guaranty_name;?></span></td>
                      ...
                      Upload Guarantor Photo</a></div></td>
                    </tr>
                    <tr>
                      ...
                      <td bgcolor="#CCCCCC">Guarantor IC/Passport: <span class="SpecialHeader"><?php echo $customer_guaranty_ic_passport;?></span></td>
                    </tr>
                    <tr>
                      <td bgcolor="#CCCCCC">Fax: <span class="SpecialHeader"><?php echo $customer_fax;?></span></td>
                      <td bgcolor="#CCCCCC">Guarantor Phone:
                        <label><span class="SpecialHeader"><?php echo $customer_guaranty_telephone;?></span></label>      </td>
                    </tr>
                    <tr>
                      <td bgcolor="#CCCCCC">Gender: 
                      <label><span class="SpecialHeader"><?php echo $t_gender;?></span></label>      </td>
                      <td bgcolor="#CCCCCC">Guarantor Information: <span class="SpecialHeader"><?php echo $customer_guaranty_info;?></span></td>
                    </tr>
                    <tr>
                      <td colspan="3" bgcolor="#CCCCCC"><div align="center"><a href="register_new_customer.php?cust=<?php echo $customer_id;?>" class="btn btn-success">Edit Customer</a> </div></td>
                    </tr>
                  </tbody></table>
        </div>
    </section>
    	...
    	<div class="container">
        	<table cellspacing="0" cellpadding="2" align="center" class="table table-bordered table-striped">
				  ...
				  ?>
                   ...
                   <tr>
                      <td>
                      	<a href="customer_card.php?cust=<?php echo $row['id']; ?>&amp;card=1" class="btn btn-success">Edit</a>
    	...
    	<div class="container">
        	<div class="row">
                ...
                <div class="col-md-6">
                	<form method="get">
                    	<div class="row form-group">
                        	<div class="col-md-6"><label for="customer_id">Customer ID/IC/Name</label></div>
        	...
        	<div class="row">
                    <table cellspacing="0" cellpadding="2" class="table table-striped table-bordered" style="width: 100%;">
                        ...
                        <thead>
                            ...
                            <tr>
                            	<td>
                                	<a href="register_new_customer.php?cust=<?php echo $row['id'];?>" class="btn btn-success">Edit</a>
                                  	<a href="customer_card.php?t_cust_id=<?php echo $row['id'];?>&amp;Submit=1" target="_self" class="btn btn-success">Card</a>
                                </td>
                                <td><?php  echo ++$count;?></td>
                                <td><?php echo  $row['id'];?></td>
