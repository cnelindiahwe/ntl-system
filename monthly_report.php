	...
	if (isset($report) && $report == "rpt01") { ?>
		...
		<section>
			...
			?>
				...
				<table cellspacing="1" cellpadding="1" style="width:80%; margin-bottom: 0%;" class="table table-striped table-bordered" align="center">
					<caption class="menu-header">Monthly Collection Report12</caption>
					<?php if ($_SESSION['center_id'] != 5) { ?>
		...
		?>
			...
			*/
						...
						?>
							<tr>
								<td><?php echo $key; ?></td>
								<td><?php if (empty($record_row['loan_out'])) {
										echo 0;
									} else {
										echo $record_row['loan_out'];
									} ?></td>
								<td><?php if (empty($record_row['collection'])) {
										echo 0;
									} else {
										echo $record_row['collection'];
									} ?></td>
								<td><?php if (empty($record_row['interest'])) {
										echo 0;
									} else {
										echo $record_row['interest'];
									} ?></td>
								<td><?php if (empty($record_row['misc'])) {
										echo 0;
									} else {
										echo $record_row['misc'];
									} ?></td>
								<td><?php if (empty($record_row['advance'])) {
										echo 0;
									} else {
										echo $record_row['advance'];
									} ?></td>
								<td><?php if (empty($record_row['repair'])) {
										echo 0;
									} else {
										echo $record_row['repair'];
									} ?></td>
								<td><?php if (empty($record_row['outbalance'])) {
										echo 0;
									} else {
										echo $record_row['outbalance'];
									} ?></td>
								<td><?php if (empty($record_row['inbalance'])) {
										echo 0;
									} else {
										echo $record_row['inbalance'];
									} ?></td>
							</tr>
						<?php
						}
            ...
            <td class="total_td"><?php echo $totalprofit;?></td><?php */ ?>
						...
						<tr>
							<td class="ConfirmValue">printed at<font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> <?php echo date("d/m/Y H:i:s"); ?></strong></font>
							</td>
							<td></td>
							<td></td>
							<td></td>
		...
		<section>
			...
			<table cellspacing="1" cellpadding="1" style="width:100%" class="table table-striped table-bordered">
				...
				<tbody>
					...
					if ($_SESSION['center_id'] != 5) { ?>
						<tr>
							<td colspan="6" class="ConfirmValue">printed at<font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> <?php echo date("d/m/Y H:i:s"); ?></strong></font>
							</td>
					...
					<?php } else { ?>
						<tr>
							<td colspan="7" class="ConfirmValue">printed at<font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong> <?php echo date("d/m/Y H:i:s"); ?></strong></font>
							</td>
	...
	?>
		<section>
			...
			<table cellspacing="1" cellpadding="1" style="width:100%" class="table table-striped table-bordered">
				...
				<td></td>
				<td colspan="9" style="text-align: right;">Total: </td>
				<td><?php // echo $total_collect;
					?></td>
				<td><?php // echo $total_clear;
					?></td>
				<td><?php // echo $total_out;
					?></td>
				<td><?php // echo $total;
					?></td>
				<td><?php // echo "0";
